...
cv2.imwrite('tests/gray_test.png',gray)
thresh = thresholding(gray)
cv2.imwrite('tests/thresh_test.png',thresh)
open = opening(gray)
cv2.imwrite('tests/opening_test.png',open)
can = canny(gray)
cv2.imwrite('tests/canny_test.png',can)